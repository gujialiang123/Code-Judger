...
class sandbox:
    ...
    def __get_time(self):
        ...
        sum_cpu_time_ns = cpu_stats['cpu_usage']['total_usage']#int(f.readline())


        total_time_used_ms = sum_cpu_time_ns // 1000000 - self.last_total_time_used_ms
    ...
    def __alarm(self):
        ...
        if used > self.timeout or real > 5 * self.timeout + 1000:
            m = self.__get_memory()
